...
class CategoryCatalog(orm.TransientModel):
    ...
    _columns = {
        'category_ids': fields.one2many('product.category.add.line', 'wizard_id', 'Categories'),
    }
...
class CategoryList(orm.TransientModel):
    ...
    _columns = {
        ...
        'category_id': fields.many2one('product.category', 'Category', required=True, help='Product category'),
    }
